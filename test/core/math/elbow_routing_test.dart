...
void main() {
  ...
  group('updateTerminals', () {
    ...
    test('6-point: move end → middle points preserved exactly', () {
      ...
      expect(
        result.contains(const Point(0, 50)),
        isTrue,
        reason: 'P1 preserved',
      );
      expect(
        result.contains(const Point(100, 50)),
        isTrue,
        reason: 'P2 preserved',
      );
      expect(
        result.contains(const Point(100, 150)),
        isTrue,
        reason: 'P3 preserved',
      );
    });
    ...
    test('2-point: returns null', () {
      final original = [const Point(0, 0), const Point(100, 100)];
